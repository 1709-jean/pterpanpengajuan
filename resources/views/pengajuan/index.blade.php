                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="row">
                                        ...
                                        <form action="{{ route('pengajuan.validasi', $item->id) }}" method="post">
                                            ...
                                            <button class="btn btn-success ml-3">Terima</button>
                                        </form>
                                        ...
                                        @else
                                        @if ($item->status == 'selesai' && Auth::user()->jabatan != 'wd2')
                                            <div>
                                                <a href="{{ route('pengajuan.realisasi', $item->id) }}" class="btn btn-info ml-3">Realisasi</a>
                                            </div>
                                        @endif
                                        @endif
                                    </div>
